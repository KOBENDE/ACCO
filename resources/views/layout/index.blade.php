...
<body>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#media-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-camera-fill"></i><span>Liste des demandes</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
            ...
            <li class="nav-item">
                ...
                <a class="nav-link collapsed" href="#">
                    <i class="bi bi-palette"></i> <!-- Icone pour Blogs-->
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>website_name</span></strong>. Tous droits réservés
        </div>
    </footer><!-- End Footer -->
